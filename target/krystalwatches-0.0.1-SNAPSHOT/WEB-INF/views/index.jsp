...
<div class=" container">
 ...
 <div class="display img img-responsive">
    ...
    <div class="cir col-md-4">
     			...
     			<img src="resources/images/formal.jpg" class=" img-circle " alt="Cinque Terre" width="100%" height="236">
      			<h3 class="kd" >Mens Stylise watch</h3>
      			
      		</div>
<div class="cir col-md-4">
      			<img src="resources/images/women.jpg" class=" img-circle " alt="Cinque Terre" width="100%" height="236">
...
<div class="cir col-md-4">
      		<img src="resources/images/sports.jpg" class=" img-circle" alt="Cinque Terre" width="100%" height="236">      
      		<br>
