...
public class ProductDAOImpl implements ProductDAO {
	...
	public void deleteProduct(int pid) {
		sessionFactory.getCurrentSession().createQuery("delete from Product as p where p.ProductId = :id")
				.setInteger("id", pid).executeUpdate();
	}

	public Product getProduct(int pid) {
		List<Product> list = sessionFactory.getCurrentSession().createQuery("from Product as p where p.ProductId = :id")
