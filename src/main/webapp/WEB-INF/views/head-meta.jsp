...
<meta charset="utf-8">
  ...
  <script src="${pageContext.request.contextPath}/resources/references/js/jquery.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath}/resources/references/js/angular.min.js"></script>
   <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/references/css/krystalwatches.css">